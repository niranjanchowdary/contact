...
<body>
	...
	<form action="<%=blobstoreService.createUploadUrl("/contacts")%>"
		...
		<div id="phone">
			PHNO <input type="button" id="addrows" name="phno" class="addperson"
				value="Addphno" onclick="add();" /> <span id="myspan"></span> <br>
			<br>
		</div>
		<div id="email">
			EMAIL <input type="button" id="addrows" name="email"
				class="addperson" value="AddEmail" onclick="addEmail();" /> <span
				id="myspan1"></span>
		</div>
		<div id="drno">
